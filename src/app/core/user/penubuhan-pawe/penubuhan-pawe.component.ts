...
@Component({
  selector: "app-penubuhan-pawe",
  templateUrl: "./penubuhan-pawe.component.html",
  styleUrls: ["./penubuhan-pawe.component.scss"],
})
export class PenubuhanPaweComponent implements OnInit {
  constructor() {}
