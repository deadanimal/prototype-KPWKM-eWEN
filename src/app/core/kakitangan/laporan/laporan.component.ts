...
export class LaporanComponent implements OnInit, OnDestroy {
  ...
  getChart() {
    let chart = am4core.create("ktlapor1", am4charts.XYChart);
  ...
  getChart1() {
    let chart = am4core.create("ktlapor2", am4charts.XYChart);
  ...
  getChart2() {
    let chart = am4core.create("ktlapor3", am4charts.XYChart);
  ...
  getChart3() {
    let chart = am4core.create("ktlapor4", am4charts.XYChart);
