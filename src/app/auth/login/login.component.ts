...
export class LoginComponent implements OnInit {
  ...
  login() {
    ...
    else if (this.loginForm.value.username == 'kakitangan') {
      this.authService.userRole = 3
      localStorage.setItem('userRole', '3');
      this.navigatePage('dashboard-kakitangan')
    }
  }
  ...
  navigatePage(path: String) {
    ...
    else if (path == 'dashboard-kakitangan') {
      return this.router.navigate(['/kakitangan/dashboard'])
    }
  }
